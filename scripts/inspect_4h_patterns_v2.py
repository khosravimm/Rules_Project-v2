...
# -*- coding: utf-8 -*-
"""
scripts/inspect_4h_patterns_v2.py

Inspect v2 4h direction-sequence patterns from KB.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Inspect v2 4h direction-sequence patterns.")
...
def sort_patterns(patterns: List[Pattern4H], key: str, descending: bool) -> List[Pattern4H]:
    if key == "strength":
